...
export const CALENDAR_THEME = {
  ...
  border: "border-solid border-slate-200 dark:border-[#1e2c49]",
  ...
  cell: {
    ...
    selecting:
      "bg-blue-100 dark:bg-blue-900/50 border-solid border-blue-300 dark:border-blue-700",
  },

  // ── Room-type group header row ─────────────────────────────────────────────
  roomTypeRow: {
    bg: "bg-blue-50/40 dark:bg-[#15213a]",
  ...
  header: {
    base: "bg-white dark:bg-[#101a2e] border-solid border-b border-r border-slate-200 dark:border-[#1e2c49]",
  ...
  dateGridGroupRow: {
    bg: "bg-blue-50/40 dark:bg-[#15213a]/50 border-solid border-b border-slate-200 dark:border-[#1e2c49]",
    occupancyText:
      "w-[7ch] max-w-full text-center tabular-nums text-slate-500 dark:text-[#8d9ab6]",
  ...
  dateGridRoomRow: {
    border: "border-solid border-b border-slate-200 dark:border-[#1e2c49]",
    todayHighlight: "bg-blue-50/40 dark:bg-[#15213a]/60",
    dragSelect:
      "bg-blue-100/80 dark:bg-blue-900/50 border-solid border-l border-r border-blue-300 dark:border-blue-700",
    skeleton: "bg-slate-200 dark:bg-[#1e2c49]",
  },

  // ── Individual room label ──────────────────────────────────────────────────
  roomLabel: {
    base: "border-solid border-b border-r border-slate-200 dark:border-[#1e2c49]",
