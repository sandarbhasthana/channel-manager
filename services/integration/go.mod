module github.com/channel-manager/channel-manager/services/integration
...
replace (
	...
	github.com/channel-manager/channel-manager/services/channel => ../channel
...
require (
	...
	github.com/channel-manager/channel-manager/platform/db v0.0.0-00010101000000-000000000000 // indirect
