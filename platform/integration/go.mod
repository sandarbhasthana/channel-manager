module github.com/channel-manager/channel-manager/platform/integration

go 1.25.0

replace (
	github.com/channel-manager/channel-manager/platform/auth => ../auth
	github.com/channel-manager/channel-manager/platform/db => ../db
)
